...
\begin{enumerate}
	...
	\lstinputlisting[float=htb, language=Kotlin, basicstyle=\ttfamily\footnotesize, label={lst:graphql-query-execution}, caption={Esecuzione asincrona della query SimulationStatus},captionpos=b]{listings/SimulationStatusQueryExec.kt}
